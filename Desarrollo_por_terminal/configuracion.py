...
# Modulo de Configuración Base y Rutas.
...
class Configuracion:
    def __init__(self):
        # Organiza Rutas del Proyecto de forma dinámica (soporta PyInstaller)
    ...
    def _preparar_entorno(self):
        """Crea automáticamente las carpetas de imágenes, historiales y archivos base."""
